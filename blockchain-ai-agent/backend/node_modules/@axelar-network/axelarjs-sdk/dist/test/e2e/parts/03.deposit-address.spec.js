...
exports.default = (function () {
    describe("Deposit Address e2e", function () {
        var axelar;
        beforeAll(function () {
        ...
        describe("getting deposit address - Terra -> Avalanche", function () {
            ...
            beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, axelar.getDepositAddress("Terra", "Avalanche", destinationAddress, "uusd")];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/];
                    }
        ...
        describe("getting deposit address - Avalanche -> Terra", function () {
            jest.setTimeout(30000);
            var response;
            ...
            beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, axelar.getDepositAddress("Avalanche", "Terra", destinationAddress, "uusd")];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/];
                    }
