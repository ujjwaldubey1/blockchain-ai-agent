...
import { ApproveTxArgs, CallContractTxArgs, CallContractWithTokenTxArgs, Environment, EvmChain, SendTokenArgs } from "./types";
...
export declare class AxelarGateway {
     ...
     */
    static create(env: Environment, chain: EvmChain, provider: ethers.providers.Provider): AxelarGateway;
