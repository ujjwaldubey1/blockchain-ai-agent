...
import { AxelarQueryAPIConfig, Environment, EvmChain, FeeInfoResponse, GasToken, TransferFeeResponse } from "./types";
export declare class AxelarQueryAPI {
     ...
     * @returns
     */
    estimateGasFee(sourceChainName: EvmChain, destinationChainName: EvmChain, sourceChainTokenSymbol: GasToken | string, estimatedGasUsed?: number): Promise<string>;
    /**
